...
typedef struct {
  char flag_name[20];
  MiniMacs (*create)(uint players,...);
} Opt;


/*
static Opt opts[] = {
  {"minimacs", create_minimacs},
  {"bitwand" , create_bitwand},
  {"bitwandfft", create_bitwandfft},
...
int main(int c, char **a) {
  ...
  mm=BitWiseANDMiniMacs_DefaultLoadFFTNew(oe, material, bdt_material);
