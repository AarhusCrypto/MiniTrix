 ...
 *
 */
MiniMacs BitWiseANDMiniMacs_DefaultLoadNew(OE oe, const char * filename, 
                                           const char * bdt_filename);

MiniMacs BitWiseANDMiniMacs_DefaultLoadFFTNew(OE oe, const char * filename, 
                                              const char * bdt_filename);
