...
static inline do_compute_mac(byte * alpha, byte * beta, byte * msg, byte * res, uint len) {
  int i = 0;
...
inline static byte compare_arrays(byte * a1, uint la1, byte * a2, uint la2) {
...
inline static void copy_array(byte * dst, uint ldst, byte * src, uint lsrc) {
