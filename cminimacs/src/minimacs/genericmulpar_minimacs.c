...
COO_DCL(GenericMulParMiniMacs, MiniMacsTripleRep, next_triple)
COO_DEF_RET_NOARGS(GenericMulParMiniMacs, MiniMacsTripleRep, next_triple) {
...
COO_DCL(GenericMulParMiniMacs, MiniMacsRep, next_single)
COO_DEF_RET_NOARGS(GenericMulParMiniMacs, MiniMacsRep, next_single) {
...
COO_DCL(GenericMulParMiniMacs, MiniMacsRep *, next_pair) 
COO_DEF_RET_NOARGS(GenericMulParMiniMacs, MiniMacsRep *, next_pair) {
...
COO_DCL(GenericMulParMiniMacs, MR, __add__, MiniMacsRep * res_out, MiniMacsRep left, MiniMacsRep right)
COO_DEF_RET_ARGS(GenericMulParMiniMacs, MR, __add__,MiniMacsRep * res_out; MiniMacsRep left; MiniMacsRep right;,res_out, left, right) {
  OE oe = this->oe;
...
MiniMacs GenericMulParMiniMacs_New(OE oe, CArena arena, MiniMacsEnc encoder,
  ...
  COO_ATTACH(GenericMulParMiniMacs, gres, next_triple);
  COO_ATTACH(GenericMulParMiniMacs, gres, next_single);
  COO_ATTACH(GenericMulParMiniMacs, gres, next_pair);
  COO_ATTACH(GenericMulParMiniMacs, gres, __add__);
