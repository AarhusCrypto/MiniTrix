...
COO_DCL(SymmetricMiniMacs, MiniMacsTripleRep, next_triple)
COO_DEF_RET_NOARGS(SymmetricMiniMacs, MiniMacsTripleRep, next_triple) {
...
COO_DCL(SymmetricMiniMacs, MiniMacsRep, next_single)
COO_DEF_RET_NOARGS(SymmetricMiniMacs, MiniMacsRep, next_single) {
...
COO_DCL(SymmetricMiniMacs, MiniMacsRep *, next_pair) 
COO_DEF_RET_NOARGS(SymmetricMiniMacs, MiniMacsRep *, next_pair) {
...
COO_DCL(SymmetricMiniMacs, MR, __add__, MiniMacsRep * res_out, MiniMacsRep left, MiniMacsRep right)
COO_DEF_RET_ARGS(SymmetricMiniMacs, MR, __add__,MiniMacsRep * res_out; MiniMacsRep left; MiniMacsRep right;,res_out, left, right) {
  OE oe = this->oe;
...
MiniMacs SymmetricMiniMacs_New(OE oe, CArena arena, MiniMacsEnc encoder,
  ...
  COO_ATTACH(SymmetricMiniMacs, gres, next_triple);
  COO_ATTACH(SymmetricMiniMacs, gres, next_single);
  COO_ATTACH(SymmetricMiniMacs, gres, next_pair);
  COO_ATTACH(SymmetricMiniMacs, gres, __add__);
