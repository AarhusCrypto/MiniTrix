 ...
 *
 */
MiniMacs BitWiseANDMiniMacsMulPar_DefaultLoadNew(OE oe, const char * filename, 
                                           const char * bdt_filename);

MiniMacs BitWiseANDMiniMacsMulPar_DefaultLoadFFTNew(OE oe, const char * filename, 
                                              const char * bdt_filename);
